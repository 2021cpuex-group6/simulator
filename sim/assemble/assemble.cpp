...
void init_opcode_map(){
    ...
    output = 0b10100;
    opecode_map.insert({"fadd", {R, output}});
    output |= (0b000010<< 26);
    opecode_map.insert({"fsub", {R, output}});
    output = 0b10100;
    output |= (0b100<< 26);
    opecode_map.insert({"fmul", {R, output}});
    output |= (0b110<< 26);
    opecode_map.insert({"fdiv", {R, output}});
    output |= (0b010110<< 26);
    opecode_map.insert({"fsqrt", {R2, output}});
    output = 0b10100;
    output |= (0b1010<< 26);
    opecode_map.insert({"floor", {R2, output}});
    output = 0b10100;
    output |= (0b101000<< 26);
    ...
    output = 0b10100;
    output |= (0b110100<< 26);
    opecode_map.insert({"itof", {R2, output}});
    output |= (0b111100<< 26);
    opecode_map.insert({"ftoi", {R2, output}});
    // jはjalの書き込みレジスタx0版
    output = 0b11011;
