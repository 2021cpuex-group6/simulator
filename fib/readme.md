...
# Fibコアシミュレータver1.90α, アセンブラ、FPUシミュ
※nextの仕様を変更しました。詳細は注意へ

## 使用方法
### シミュレータ
makeコマンドでmainファイルを作成し、「`./main fib.s`」のように実行ファイルを入力としてください。（複数ファイルで実行する場合は，実行時引数に複数ファイルを指定すればOK）
