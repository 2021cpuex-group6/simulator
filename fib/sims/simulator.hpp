...
constexpr int32_t MMIO_SEND = DATA_START - WORD_BYTE_N; // MMIOの送信アドレス
constexpr int32_t MMIO_RECV = DATA_START - 2*WORD_BYTE_N; // MMIOの受信アドレス
constexpr int32_t MMIO_VALID = DATA_START - WORD_BYTE_N; // MMIOのvaildのアドレス
